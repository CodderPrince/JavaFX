...
class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ClockPane1 clock = new ClockPane1();  // Create a clock instance
        Scene scene = new Scene(clock, 300, 300);  // Set scene with clock pane
        primaryStage.setTitle("Clock");  // Set the title of the window
